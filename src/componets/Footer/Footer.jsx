...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-white dark:bg-[#171717] sm:pt-6 lg:pt-8">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="flex flex-col items-center justify-between gap-2 border-b border-t py-6 md:flex-row">
            <div className="mb-3 text-center md:mb-0 md:text-left">
              <span className="font-bold uppercase tracking-widest text-gray-800 dark:text-light-color">
              special offers
              </span>
              <p className="text-gray-500 capitalize dark:text-second-light-color">subscribe to receive notifications of our special offers</p>
            </div>
          ...
          <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div className="mb-16 grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-6 lg:gap-8">
              <div className="col-span-full lg:col-span-2">
                ...
                <p className="mb-6 text-gray-500 sm:pr-8 dark:text-second-light-color">
              ...
              <div>
                <div className="mb-4 font-bold uppercase tracking-widest text-gray-800 dark:text-light-color">
                  Products
                </div>
            ...
            <p className="border-t py-8 text-center text-sm text-gray-800 dark:text-second-light-color">
