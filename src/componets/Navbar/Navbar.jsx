...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="bg-white dark:bg-[#171717] fixed start-0 end-0 top-0 px-4  z-30 border-b border-b-[#303030]">
        <div className="mx-auto max-w-7xl px-1 sm:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            ...
            >
              <Link className="flex items-center">
                ...
                >
                  ...
                  />
                  <path
                    d="M1 26.527C1 26.527 11.26 23.0552 25.1058 26.527"
                    stroke="#0AAD0A"
                    strokeWidth="1.28276"
                    strokeMiterlimit="10"
                    strokeLinecap="round"
                  />
                  <path
                    className="dark:fill-light-color"
                    d="M36.5269 25V6.34164H48.8807V9.59409H40.4717V14.04H48.0608V17.2925H40.4717V25H36.5269Z"
                    fill="#21313C"
                  />
                  <path
                    className="dark:fill-light-color"
                ...
                {/* <img className="h-6 w-auto" src={logo} alt="FreshCart Logo" /> */}
              </Link>
                  ...
                  <div className="grid grid-cols-5 items-center">
                    <div className="col-span-4">
                      <Link
                        to="/login"
                        type="button"
                        className="text-gray-900 px-3 dark:px-2 focus:ring-green-300 dark:text-light-color"
                      >
                        Login
                      </Link>
                      <Link
            ...
            {userLogin && (
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 divide-indigo-50 divide-x">
                <div className="hidden pe-2 md:block">
                  <Link
                    to={"/allorders"}
                    type="button"
                  ...
                  <Link
                    to="/cart"
                    type="button"
                    className="relative rounded-full p-1 text-gray-400 hover:text-gray-900 group focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                  >
                    <span className="absolute -inset-1.5"></span>
                    <span className="sr-only">View all orders</span>
                    <i className="fa-solid fa-basket-shopping dark:group-hover:text-light-color"></i>
                    <span>
                      {isCartCountLoading ? (
                        <i className="fa-solid fa-circle-notch fa-spin px-1 "></i>
                      ) : (
                        <span className="px-1 bg-gold-color rounded-lg ms-1 text-gray-500 group-hover:text-[#171717]">
                          {cartCount}
                        </span>
                      )}
                    </span>
